                            ...
                            <div class="media">
                              <div class="media-size-email">                                       
                                <label class="d-block mb-0" for="chk-ani">
                                  <input class="checkbox_animated" id="chk-ani" type="checkbox" checked="">
                                </label><i class="like" data-feather="star"></i><img class="me-3 rounded-circle" src="{{asset('assets')}}/images/user/user.png" alt="">
                              </div>
                              <div class="media-body">
                                <h6>Pork Lorn </h6>
                                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC.</p><span>11:59 PM</span>
                              </div>
                            </div>
                            <div class="media">
                              <div class="media-size-email">                                       
                                <label class="d-block mb-0" for="chk-ani">
                                  <input class="checkbox_animated" id="chk-ani" type="checkbox" checked="">
                                </label><i data-feather="star"></i><img class="me-3 rounded-circle" src="{{asset('assets')}}/images/user/user.png" alt="">
                              </div>
                              <div class="media-body">
                                <h6>Dee Deo</h6>
